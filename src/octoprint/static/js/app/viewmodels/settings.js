function SettingsViewModel(loginStateViewModel, usersViewModel) {
    ...
    self.appearance_available_colors = ko.observable(["default", "dark-gray", "silver", "purple", "blue", "petrol-blue", "octoprint", "lime", "cadmium", "cadmium", "orange", "soft-red", "fuchsia", "lightpink"]);
